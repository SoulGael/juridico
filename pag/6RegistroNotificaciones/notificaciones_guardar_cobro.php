...
{
pg_query("update tbl_gestion_cobranzas_cobros 
...
pg_query("update tbl_instalacion 
	...
	where id_instalacion=(select max(id_instalacion) 
		...
		where id_cliente=(select id_cliente from tbl_gestion_cobranzas_cobros where id_gestion='".$id."')) and estado_servicio!='a'") or die("Error de conexion. ". pg_last_error());	

pg_query("update tbl_gestion_cobranzas_cobros set 
...
{
	pg_query("update tbl_gestion_cobranzas_cobros set reg_notif_ges1='".$ges1."', reg_notif_ob1='".$are1."', reg_notif_usu1='".$usuar."', reg_notif_fecha1=date 'now()' where id_gestion='".$id."'") or die("Error de conexion. ". pg_last_error());
...
{
	pg_query("update tbl_gestion_cobranzas_cobros set reg_notif_ges2='".$ges2."', reg_notif_ob2='".$are2."', reg_notif_usu2='".$usuar."', reg_notif_fecha2=date 'now()' where id_gestion='".$id."'") or die("Error de conexion. ". pg_last_error());
	echo '<div class="alert alert-success alert-dismissable">
	<button type="button" class="close" data-dismiss="alert">&times;</button>
...
{
	pg_query("update tbl_gestion_cobranzas_cobros set reg_notif_ges3='".$ges3."', reg_notif_ob3='".$are3."', reg_notif_usu3='".$usuar."', reg_notif_fecha3=date 'now()' where id_gestion='".$id."'") or die("Error de conexion. ". pg_last_error());
	echo '<div class="alert alert-success alert-dismissable">
	<button type="button" class="close" data-dismiss="alert">&times;</button>
